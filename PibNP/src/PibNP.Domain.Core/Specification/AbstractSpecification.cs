...
namespace Pib.NP.Domain.Core.Specification
{
    public abstract class AbstractSpecification<T> : ISpecification<T>
    {
        ...
        public ISpecification<T> And<TSpec>() where TSpec : ISpecification<T>, new()
        {
        ...
        public ISpecification<T> AndNot<TSpec>() where TSpec : ISpecification<T>, new()
        {
        ...
        //OR NOT
        public ISpecification<T> OrNot<TSpec>() where TSpec : ISpecification<T>, new()
        {
