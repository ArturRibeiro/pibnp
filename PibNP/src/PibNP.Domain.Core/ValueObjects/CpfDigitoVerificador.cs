...
namespace PibNP.Domain.Core.ValueObjects
{
    ...
    public class CpfDigitoVerificador
    {
        ...
        /// </summary>
        public CpfDigitoVerificador ComMultiplicadores(params int[] multiplicadores)
        {
            this.multiplicadores.Clear();
        ...
        /// Ex: No caso do CNPJ, quando o divisor for menor do que 2, o dígito retornado deve ser "0"
        /// </summary>
        public CpfDigitoVerificador Modulo(int modulo)
        {
            this.modulo = modulo;
            return this;
        }
        ...
        /// </summary>
        public CpfDigitoVerificador SomandoAlgarismos()
        {
        ...
        /// </summary>
        public CpfDigitoVerificador InvertendoMultiplicadores()
        {
            this.multiplicadores.Reverse();
            return this;
        }

        public CpfDigitoVerificador SemComplementarDoModulo()
        {
